package videoView{
	...
	public class view extends MovieClip {
		...
		{
			var _leftHeight = this.stage.stageHeight - this.leftBase.y;
			if(_leftHeight<610){
				_leftHeight = 610;
			}
		...
		private function renderLayout():void {
			...
			this.layoutData.leftBase = { x:this.body_mc.x + this.leftBase.x, y:this.body_mc.y + this.leftBase.y, w:this.leftBase.width, h:this.leftBase.height };
			this.layoutData.centerBase = { x:this.body_mc.x + this.centerBase.x, y:this.body_mc.y + this.centerBase.y, w:this.centerBase.width, h:this.centerBase.height };
			this.layoutData.rightBase = { x:this.body_mc.x + this.rightBase.x, y:this.body_mc.y + this.rightBase.y, w:this.rightBase.width, h:this.rightBase.height };
			/**/
