...
public class VideoConfig {
	...
	public static var HOST:String            = "216.172.128.26";
	public static var PORT:int               = 10010;
	public static var connectRTMP:String; //] 115.231.24.252: 连接成功------9007------------------costTime====781
	public static var roomID:int             = 100151;//rover022 101116443,101116441,101120981,101116395,101116444,101116395
	public static var loginKey:String        = "et8i0djvqe4gqhnlmm85u9qbf6";
