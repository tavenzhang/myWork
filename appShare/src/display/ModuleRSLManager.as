...
public class ModuleRSLManager implements IVideoModule {

    private var moduleDictionary:Dictionary = new Dictionary();
    private static var _instance:ModuleRSLManager;
    ...
    public static function get instance():ModuleRSLManager {
        if (!_instance) {
            _instance = new ModuleRSLManager();
        }
        return _instance;
    }
