 ...
 *
 */
public class DataCenterManger extends Object implements ISocketApp {
    ...
    public static function getInstance():DataCenterManger {
        if (_instance == null) {
            _instance = new DataCenterManger();
        }
        return _instance;
    }
    ...
    //获取钻石数目
    public static function get myMony():int {
