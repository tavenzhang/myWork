...
public class ChatAndErrorControl extends BaseControl {
    ...
    override public function regMsg():void {
        ...
        super.regMagHanlde(CBProtocol.chat_formib_24003, handleMessgae);
        ...
        errorArray[3] = "参数错误";
        //转盘游戏
        errorArray[2121] = "游戏尚未开启！";
        errorArray[2122] = "抽奖券不够！";
        errorArray[2121] = "游戏尚未开启！";
        //开启禁言
        errorArray[2120] = "主播开启了禁止聊天，暂时无法聊天！";
    ...
    override public function handleMessgae(data:*):void {
        ...
        switch (data.cmd) {
            case CBProtocol.chat_formib_24003://主播开启禁言
                DataCenterManger.vipInfo.forbitChat = data.forbidChat;
                ...
                if (DataCenterManger.vipInfo.forbitChat) {
                    ClientManger.getInstance().addChatSpanMessage({
                        message: "[主播通知]:" + "主播开启了房间禁言",
                        color: "0xFF0000"
                    });
                    alertString = "成功开启房间禁言！"
                }
                else {
                    ClientManger.getInstance().addChatSpanMessage({
                        message: "[主播通知]:" + "主播恢复了房间聊天",
                        color: "0x00FF00"
                    });
                    alertString = "成功关闭房间禁言！"
                }
                if (DataCenterManger.getInstance().isRoomAdmin) {
                    Alert.Show(alertString, "提示");
                }
                break;
