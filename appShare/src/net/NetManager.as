...
//        Cc.log();
    ...
    //静态方法用于缩写
    public static function sendOnceDataObject(sendData:*,callFun:Function):void{
        NetManager.getInstance().sendOnceDataObject(sendData,callFun);
    }

    public static function sendDataObject(_obj:Object, cmd:int = -1):void{
        NetManager.getInstance().sendDataObject(_obj,cmd);
    }

    public function sendOnceDataObject(sendData:*,callFun:Function):void{
        ControlsManger.sendOneTimesMsg(sendData,callFun);
    }
